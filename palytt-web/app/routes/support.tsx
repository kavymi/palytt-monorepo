...
export const Route = createFileRoute('/support')({
  ...
  head: () => ({
    meta: [
      { title: 'Support - Palytt' },
      { name: 'description', content: 'Get help with Palytt. Contact our support team or browse frequently asked questions.' },
    ],
  }),
})
